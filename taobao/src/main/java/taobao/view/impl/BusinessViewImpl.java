...
import taobao.dao.BusinessDao;
import taobao.dao.impl.BusinessDaoImpl;
...
public class BusinessViewImpl implements BusinessView{
    ...
    public void listBusinessAll() {
        ...
        System.out.println("商家编号\t商家名称\t商家地址\t商家介绍");
        for(Business b : list) {
            System.out.println(b.getBusinessId()+"\t"+b.getBusinessName()+"\t"+b.getBusinessAddress()+"\t"+b.getBusinessExplain()+"\t");
        }
